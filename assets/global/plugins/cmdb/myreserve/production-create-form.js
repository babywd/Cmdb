        ...
        init: function () {
            ...
            form.validate({
                ...
                rules: {
                    ...
                    production_outside_user_departments: {
                        required: true
                    },					
                },
			...
			$(this).button('loading');	   
				$.ajax({
					...
					success: function(obj) {
                      ...
                      if (obj['status'] == "1"){
                          alert('预定成功');
						  window.location.href="../production_list/";
                      }else{
                          alert('预定失败,请重新预定');
                          window.location.href="../production_create/";
                      }
