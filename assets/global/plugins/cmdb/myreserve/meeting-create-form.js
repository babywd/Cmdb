			...
			$(this).button('loading');	   
				$.ajax({
					...
					success: function(obj) {
                      if (obj['status'] == "1"){
                            alert('预定成功');
                            var id= $('#meeting_place').val();
                            window.location.href="../meeting_list/?meeting_place="+id;
                      }else{
                            alert('预定失败,请重新预定');
                            window.location.href="../meeting_create/";
                      }
