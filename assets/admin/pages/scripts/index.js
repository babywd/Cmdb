var Index = function () {
    ...
    return {
        ...
        initDashboardDaterange: function () {
            ...
            $('#mydashboard-report-range').daterangepicker({
                ...
                function (start, end) {
                    $('#mydashboard-report-range span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
                }
            );


            $('#mydashboard-report-range span').html(moment().subtract('days', 29).format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
            $('#mydashboard-report-range').show();
        }
